package io.hhplus.tdd.point.common.logtrace.impl;
...
import io.hhplus.tdd.point.common.logtrace.LogTracer;
import io.hhplus.tdd.point.common.logtrace.TraceStatus;
...
public class GlobalTraceHandler {
	...
	@Pointcut("execution(* io.hhplus.tdd.point.api..*(..)) ")
	public void all() {
	}
